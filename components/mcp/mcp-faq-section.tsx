...
type MCPFAQSectionProps = {
  content: SiteContent["mcpGatewayPage"]["sections"]["faq"];
};

export function MCPFAQSection({ content }: MCPFAQSectionProps) {
  return (
    <section className="relative overflow-hidden py-16 sm:py-20 lg:py-24" id="faq">
